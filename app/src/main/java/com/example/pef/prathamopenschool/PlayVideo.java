    ...
    private void showQuestion() {
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ScoreDBHelper score = new ScoreDBHelper(PlayVideo.this);
                Score sc = new Score();
                ...
                if (gid.contains(","))
                    gid = gid.split(",")[0];
                sc.GroupID = gid;
                String deviceId = Settings.Secure.getString(PlayVideo.this.getContentResolver(), Settings.Secure.ANDROID_ID);
                ...
                // Score Entry
                score.Add(sc);
                BackupDatabase.backup(PlayVideo.this);
